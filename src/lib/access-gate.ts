...
// `_next/image`), the favicon, and the DELIBERATELY public passport tier
// (`passport/`). A 401 on a parser-loaded static asset — or on a gated route
...
export const GATE_BYPASS_PREFIXES = ["_next/static", "_next/image", "favicon.ico", "passport/"] as const;
