...
of what the declaration covers, and issue/validity dates. ${SHARED_RULES}`,
  claimTypes: [
    "material",
    "recycled_content",
...
reference, the sample/scope described, and the report date. ${SHARED_RULES}`,
  claimTypes: [
    "measured_parameter",
    "test_method",
    "stated_limit",
...
treatment/issue dates. ${SHARED_RULES}`,
  claimTypes: [
    "heat_treatment",
    "ispm15_mark",
    "issuer_identity",
...
covered products/scope, and the declaration date. ${SHARED_RULES}`,
  claimTypes: [
    "grade",
    "recycled_content",
    ...
    properties: {
      claims: {
        ...
        items: {
          type: "object",
          additionalProperties: false,
          required: ["claim_type", "confidence", "provenance"],
          properties: {
